...
def index():
    if request.method == "POST":
        ...
        if video_file:
            # Санация имени файла для безопасности
            sanitized_filename = Utils.sanitize_filename(video_file.filename)
            ...
            # Запускаем процесс обработки видео
            processed_video_path = MediaHandler.process_with_media_processor(file_path)
